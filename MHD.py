...
def modified_Hausdorff_distance(model_set, test_set):

    # Find pairwise distance
    D_mat = numpy.sqrt(inner1d(model_set, model_set)[numpy.newaxis].T + inner1d(test_set, test_set) - 2 * (numpy.dot(model_set, test_set.T)))
...
print(1/(0.1+modified_Hausdorff_distance(band_to_cloud(kpts,bandB),band_to_cloud(kpts,bandA))))
